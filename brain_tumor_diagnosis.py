...
os.makedirs('../content/drive/MyDrive/brain_tumor_dataset/augmented-images')
os.makedirs('../content/drive/MyDrive/brain_tumor_dataset/augmented-images/yes')
os.makedirs('../content/drive/MyDrive/brain_tumor_dataset/augmented-images/no')
...
augmented_data_path ='../content/drive/MyDrive/brain_tumor_dataset/augmented-images/'
